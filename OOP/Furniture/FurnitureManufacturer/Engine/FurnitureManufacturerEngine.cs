namespace FurnitureManufacturer.Engine
{
    ...
    public sealed class FurnitureManufacturerEngine : IFurnitureManufacturerEngine
    {
            ...
            foreach (var command in commands)
            {
                ...
                switch (command.Name)
                {
                    case EngineConstants.CreateCompanyCommand:
                        ...
                        commandResult = this.CreateCompany(
                            companyName,
                    ...
                    case EngineConstants.AddFurnitureToCompanyCommand:
                        ...
                        commandResult = this.AddFurnitureToCompany(
                            companyToAddTo,
                            furnitureToBeAdded);
                        commandResults.Add(commandResult);
                        break;
                    case EngineConstants.RemoveFurnitureFromCompanyCommand:
                        ...
                        commandResult = this.RemoveFurnitureFromCompany(
                            companyToRemoveFrom,
                    ...
                    case EngineConstants.FindFurnitureFromCompanyCommand:
                        ...
                        commandResult = this.FindFurnitureFromCompany(
                            companyToFindFrom,
                            furnitureToBeFound);
                        commandResults.Add(commandResult);
                        break;
                    ...
                    case EngineConstants.CreateTableCommand:
                        ...
                        commandResult = this.CreateTable(
                            tableModel,
                            tableMaterial,
                            tablePrice,
                            tableHeight,
                    ...
                    case EngineConstants.CreateChairCommand:
                        ...
                        commandResult = this.CreateChair(
                            chairModel,
                            chairMaterial,
                            chairPrice,
                            chairHeight,
                    ...
                    default:
                        commandResults.Add(
                            string.Format(
                            EngineConstants.InvalidCommandErrorMessage,
                            command.Name));
                        break;
                }
            }
        ...
        private string AddFurnitureToCompany(string companyName, string furnitureName)
        {
            ...
            if (!this.furnitures.ContainsKey(furnitureName))
            {
                return string.Format(
                    EngineConstants.FurnitureNotFoundErrorMessage,
                    furnitureName);
            }
            ...
            return string.Format(
                EngineConstants.FurnitureAddedSuccessMessage,
                furnitureName,
                companyName);
        }
        ...
        private string RemoveFurnitureFromCompany(string companyName, string furnitureName)
        {
            ...
            return string.Format(
                EngineConstants.FurnitureRemovedSuccessMessage,
                furnitureName,
                companyName);
        }
            ...
            decimal width)
        {
            ...
            var table = this.furnitureFactory.CreateTable(
                model,
                material,
                price,
                height,
            ...
            string type)
        {
            ...
            switch (type)
            {
                case EngineConstants.NormalChairType:
                    chair = this.furnitureFactory.CreateChair(
                        model,
                        material,
                        price,
                        height,
                ...
                case EngineConstants.AdjustableChairType:
                    chair = this.furnitureFactory.CreateAdjustableChair(
                        model,
                        material,
                        price,
                        height,
                ...
                case EngineConstants.ConvertibleChairType:
                    chair = this.furnitureFactory.CreateConvertibleChair(
                        model,
                        material,
                        price,
                        height,
        ...
        private string AdjustChairHeight(string model, decimal height)
        {
            ...
            {
                return string.Format(
                    EngineConstants.FurnitureIsNotAdjustableChairErrorMessage,
                    model);
            }
            ...
            return string.Format(
                EngineConstants.ChairHeightAdjustedSuccessMessage,
                model,
                height);
        }
        ...
        private string ConvertChair(string model)
        {
            ...
            {
                return string.Format(
                    EngineConstants.FurnitureIsNotConvertibleChairErrorMessage,
                    model);
            }
