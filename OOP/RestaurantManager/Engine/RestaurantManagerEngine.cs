namespace RestaurantManager.Engine
{
    ...
    public sealed class RestaurantManagerEngine : IRestaurantManagerEngine
    {
            ...
            foreach (var command in commands)
            {
                ...
                switch (command.Name)
                {
                    ...
                    case EngineConstants.AddRecipeToRestaurantCommand:
                        commandResult = this.AddRecipeToRestaurant(
                            command.Parameters["restaurant"], command.Parameters["recipe"]);
                        break;
                    case EngineConstants.RemoveRecipeFromRestaurantCommand:
                        commandResult = this.RemoveRecipeFromRestaurant(
                            command.Parameters["restaurant"], command.Parameters["recipe"]);
                        break;
                    ...
                    default:
                        commandResult = string.Format(
                            EngineConstants.InvalidCommandMessage, command.Name);
                        break;
                }
            ...
            bool isCarbonated)
        {
            ...
            var drink = this.recipeFactory.CreateDrink(
                name,
                price,
                calories,
                quantityPerServing,
            ...
            bool containsPasta)
        {
            ...
            var salad = this.recipeFactory.CreateSalad(
                name,
                price,
                calories,
                quantityPerServing,
        ...
        private string CreateMainCourse(
            string name,
            decimal price,
            int calories,
            int quantityPerServing,
            ...
            string type)
        {
            ...
            var mainCourse = this.recipeFactory.CreateMainCourse(
                name,
                price,
                calories,
                quantityPerServing,
            ...
            bool isVegan)
        {
            ...
            var dessert = this.recipeFactory.CreateDessert(
                name,
                price,
                calories,
                quantityPerServing,
            ...
            if (recipe is IMeal)
            {
                ...
                catch (ArgumentException)
                {
                    return string.Format(
                        EngineConstants.InapplicableCommandMessage, "ToggleVegan", name);
                }

                return string.Format(
                    EngineConstants.CommandSuccessfulMessage,
                    "ToggleVegan", 
                    meal.IsVegan.ToString().ToLower());
            }
            else
            {
                return string.Format(
        ...
        private string ToggleSugar(string name)
        {
            ...
            if (recipe is IDessert)
            {
                ...
                return string.Format(
                    EngineConstants.CommandSuccessfulMessage,
                    "ToggleSugar", 
                    dessert.WithSugar.ToString().ToLower());
            }
            else
            {
                return string.Format(
                    EngineConstants.InapplicableCommandMessage,
                    "ToggleSugar",
                    name);
            }
        }
        ...
        private string AddRecipeToRestaurant(string restaurantName, string recipeName)
        {
            ...
            {
                return string.Format(
                    EngineConstants.RestaurantDoesNotExistMessage, restaurantName);
            }
            ...
            return string.Format(
                EngineConstants.RecipeAddedMessage, recipeName, restaurantName);
        }
        ...
        private string RemoveRecipeFromRestaurant(string restaurantName, string recipeName)
        {
            ...
            return string.Format(
                EngineConstants.RecipeRemovedMessage, recipeName, restaurantName);
        }
